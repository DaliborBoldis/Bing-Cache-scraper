...
async function sendQueuedEmail(email, data) {
	try {
		...
		let transporter = nodemailer.createTransport({
			...
			auth: {
				user: "dan@aiprofound.cloud", // generated ethereal user
				pass: "s7D3nU6@tRihg!h", // generated ethereal password
			},
		});

		// send mail with defined transport object
		await transporter.sendMail({
			from: '"Dan from AI Profound" <dan@aiprofound.cloud>', // sender address
			to: email.trim(), // list of receivers
			subject: "Elevate " + data.pageTitle + " with AI Profound's Cutting-Edge Solutions", // Subject line
			text:
				`Hello ` +
				data.pageTitle +
				` team!
	
			Greetings from AI Profound!
			
			The future is here, and it’s powered by AI. It's transforming the way we do business and if you're not on board yet, now is the time.
			
			We specialize in equipping businesses like yours with AI services, tailored to boost efficiency, improve customer engagement, and drive growth.
			
			What we offer:
			
			Automated Customer Service & Buying Assistance
			Language Translation & Data Analysis
			Personalized Recommendations & Prompt Engineering
			Also, take advantage of our versatile freelancer services, delivering on-demand expertise whenever you need it.
			
			Visit our website aiprofound.cloud to discover more about us and our transformative solutions.
			
			Let's revolutionize ` +
				data.pageTitle +
				` together! Contact us today to schedule a personalized consultation and take the first step towards an AI-driven future.
			
			Embrace the AI revolution with AI Profound. Let's make ` +
				data.pageTitle +
				` unstoppable!
			
			Best,`, // plain text body
			html:
				`
			<p>Hello ` +
				data.pageTitle +
			...
			<p>Greetings from AI Profound!</p>
			
			<p>The future is here, and it’s powered by AI. It's transforming the way we do business and if you're not on board yet, now is the time.</p>
			
			<p>We specialize in equipping businesses like yours with AI services, tailored to boost efficiency, improve customer engagement, and drive growth.</p>
			
			<p>What we offer:</p>
			
			<p><strong>Automated Customer Service & Buying Assistance</strong></p>
			<p><strong>Language Translation & Data Analysis</strong></p>
			<p><strong>Personalized Recommendations & Prompt Engineering</strong></p>
			<p>Also, take advantage of our versatile freelancer services, delivering on-demand expertise whenever you need it.</p>
			
			<p>Visit our website <a href="http://aiprofound.cloud/">aiprofound.cloud</a> to discover more about us and our transformative solutions.</p>
			
			<p>Let's revolutionize ` +
				data.pageTitle +
				` together! Contact us today to schedule a personalized consultation and take the first step towards an AI-driven future.</p>
			
			<p>Embrace the AI revolution with AI Profound. Let's make ` +
				data.pageTitle +
				` unstoppable!</p>
			...
			<div style="font-family: Arial, sans-serif; color: #333333;">
			  ...
			  <h3>Dan</h3>
			  <p>AI Enthusiast</p>
			  <h2 style="color: #333333;">AI Profound</h2>
			  <p>🌐 <a href="http://aiprofound.cloud/" style="color: #337ab7; text-decoration: none;">aiprofound.cloud</a></p>
			  <p>📨 <a href="mailto:dan@aiprofound.cloud" style="color: #337ab7; text-decoration: none;">dan@aiprofound.cloud</a></p>
			  <img src="https://aiprofound.cloud/wp-content/uploads/2023/04/logo.png" alt="AI Profound Logo" width="200" height="50">
			  <p style="color: #777777; font-style: italic;">"Transforming Businesses, One Algorithm at a Time"</p>
			  <hr>
			  <p style="font-size: 0.8em; color: #777777;">Note: This email and any files transmitted with it are confidential and intended solely for the use of the individual or entity to whom they are addressed. If you have received this email in error please notify the sender. Please note that any views or opinions presented in this email are solely those of the author and do not necessarily represent those of the company.</p>
			</div>
		  `, // html body
		});
		console.log("Mail to: " + email + " successfully sent!");
	} catch (error) {
		console.log("An error occured while sending email to " + email + " - Error: " + error);
	}
}
